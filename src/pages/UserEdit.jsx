...
export default function UserEdit() {
    ...
    useEffect(()=>{
        ...
        const getUser=async()=>{
            ...
            setLoading(true)
            const res= await axios.get(`https://mobo-user.herokuapp.com/users/${param.id}`)
               ...
               <div> <Formik
                        ...
                        onSubmit={async(values,{resetForm})=>{
                           ...
                           setLoading(true)
                            ...
                            const res=await axios.put(`https://mobo-user.herokuapp.com/users/${param.id}`,values)   
        
                            console.log(res)
                            if(res.status === 200) setInfo("User Updated Successfully")
                            else if(res.status === 400) setInfo("Error in Updating User")
                            resetForm()
                            setLoading(false)
                            }
                            catch(err)
